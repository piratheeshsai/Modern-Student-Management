            ...
            <div class="container my-auto">
                <div class="row">
                    <div class="col-lg-4 col-md-8 col-12 mx-auto">
                        <div class="card z-index-0 fadeIn3 fadeInBottom border border-secondary">
                            ...
                            <div class="card-body">
                                <form @submit.prevent="submit" class="text-start">
                                    ...
                                    <div
                                        class="input-group input-group-outline mt-4 mb-3"
                                        :class="{'is-filled': form.password}"
                                    >
                                    ...
                                    <div class="text-center">
                                        <button :disabled="form.processing" type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">
                                            Sign in
                                        </button>
                                    </div>
